    ...
    <header className="w-full bg-primary-bg py-8 lg:py-12 border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row justify-between items-center gap-8">
        ...
        <Link to="/" className="text-center lg:text-left flex items-center group">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" className="w-10 h-10 md:w-12 md:h-12 text-navy mr-4 lg:mr-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v18M7 9h10" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M2 9v2c0 5.5 4.5 10 10 10s10-4.5 10-10V9" opacity="0.3" />
          </svg>
        ...
        <div className="flex items-center gap-6 text-navy mt-4 lg:mt-0">
          <button className="hover:opacity-75 transition-opacity" aria-label="Panier">
            <ShoppingBag className="w-6 h-6 stroke-[1.5]" />
          </button>
          <button className="hover:opacity-75 transition-opacity" aria-label="Espace de connexion">
